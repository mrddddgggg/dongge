...
[task_local]
#边赚边玩通用
40 0,2 * * * https://github.com/mrddddgggg/dongge/raw/main/jd_hwyf.js, tag=边赚边玩通用, img-url=https://user-images.githubusercontent.com/94060932/150673806-66451600-5419-47f4-998a-3b5ad579a3f1.jpg, enabled=true

================Loon==============
[Script]
cron "40 0,2 * * *" script-path=https://github.com/mrddddgggg/dongge/raw/main/jd_hwyf.js,tag=边赚边玩通用

===============Surge=================
边赚边玩通用 = type=cron,cronexp="40 0,2 * * *",wake-system=1,timeout=3600,script-path=https://github.com/mrddddgggg/dongge/raw/main/jd_hwyf.js

============小火箭=========
边赚边玩通用 = type=cron,script-path=https://github.com/mrddddgggg/dongge/raw/main/jd_hwyf.js, cronexpr="40 0,2 * * *", timeout=3600, enable=true
 */
